...
TEST(SaturateCastTest, Float32ToSigned32) {
  ...
  constexpr float kIntMax = std::numeric_limits<int32_t>::max();
...
TEST(SaturateCastTest, Float32ToSigned64) {
  ...
  constexpr float kFloatMax = std::numeric_limits<float>::max();
  constexpr float kIntMax = std::numeric_limits<int64_t>::max();
...
TEST(SaturateCastTest, Float64ToSigned64) {
  ...
  constexpr double kDoubleMax = std::numeric_limits<double>::max();
  constexpr double kIntMax = std::numeric_limits<int64_t>::max();
...
TEST(SaturateCastTest, Float32ToUnsigned64) {
  ...
  constexpr float kFloatMax = std::numeric_limits<float>::max();
  constexpr float kIntMax = std::numeric_limits<uint64_t>::max();
  const ValuePair kValuePairs[] = {
