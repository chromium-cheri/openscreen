...
class
 ...
 public:
  inline GenericEnumTableEntry(int32_t value);  // NOLINT
  inline GenericEnumTableEntry(int32_t value, absl::string_view str);
 ...
 private:
  ...
  constexpr bool has_str() const { return !str_.empty(); }
...
inline GenericEnumTableEntry::GenericEnumTableEntry(int32_t value)
    : value_(value) {}

inline GenericEnumTableEntry::GenericEnumTableEntry(int32_t value,
                                                    absl::string_view str)
    : str_(std::string(str)), value_(value) {}
 ...
 private:
  ...
  constexpr EnumTable(std::initializer_list<Entry> data, bool is_sorted)
    ...
    for (std::size_t i = 0; i < data.size(); i++) {
      data_.emplace_back(data.begin()[i]);
