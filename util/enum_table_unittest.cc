...
const EnumTable<MyEnum, false> kUnsorted({{MyEnum::kOne, "ONE"},
                                          {MyEnum::kZero, "ZERO"},
                                          {MyEnum::kTwo, "TWO"}});
...
const EnumTable<MyEnum, false> kUnsortedMissing({{MyEnum::kOne, "ONE"},
                                                 {MyEnum::kZero},
                                                 {MyEnum::kTwo, "TWO"}});
...
TEST(EnumTableDeathTest, Unsorted) {
  EXPECT_DEATH((EnumTable<MyEnum, false>({{MyEnum::kZero, "ZERO"},
                                          {MyEnum::kOne, "ONE"},
                                          {MyEnum::kTwo, "TWO"}})),
               ".*Entries are actually sorted, please remove false IsSorted "
               "template parameter.*");
}
