...
class LoggingTest : public ::testing::Test {
 ...
 protected:
  ...
  void VerifyLogs() {
    EXPECT_EQ(expected_messages.size(), log_messages.size());
    auto expected_it = expected_messages.begin();
    auto actual_it = log_messages.begin();
    // NOTE: This is somewhat brittle; it relies on details of how the default
    // platform formats log messages to skip irrelevant/dynamic parts of the
    // message.
  ...
  void ExpectBreakAndClear() {
    ...
    DisableBreakForTest(&break_was_called);
  }
