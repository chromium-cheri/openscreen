...
// Removes ALL whitespace from the string, based on the present C locale. This
// includes spaces, tabs, and returns. This is useful for string comparisons
// where whitespace doesn't matter, or, in the case of JSON serialization, is
// dependent on build configuration and other settings.
