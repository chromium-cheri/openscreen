...
copy of the following build tools:
 ...
 On Mac, ensure XCode is installed. On Linux, ensure that libstdc++ is installed,
 as clang depends on the system instance of it. Passing the "is_gcc=true" flag
 on Linux enables building using gcc instead. Note that g++ must be installed.
