...
class FrameCollector {
 ...
 private:
  ...
  std::vector<PayloadPart> chunks_;

  // Starts at zero, and accumulates the payload size as each unseen chunk is
  // collected. When the frame is complete, this is the size of the assembled
  // frame's payload data.
