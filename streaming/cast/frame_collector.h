...
class FrameCollector {
 public:
  ...
  // ownership of the memory backing the |buffer|, into which |part.payload| is
 ...
 private:
  ...
  // Starts at zero, and accumulates the payload size of each chunk. When the
  // frame is complete, this is the size of the assembled frame's payload data.
  size_t payload_size_so_far_;
};
