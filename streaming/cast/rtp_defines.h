...
// LAN Ethernet).
constexpr size_t kMaxRtpPacketSizeForIpv4UdpOnEthernet = 1500 - 20 - 8;
constexpr size_t kMaxRtpPacketSizeForIpv6UdpOnEthernet = 1500 - 40 - 8;
...
constexpr int kMinValidRtpPacketSize = 18;
...
constexpr uint8_t kMarkerBitMask = 0b10000000;
