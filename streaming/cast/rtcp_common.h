...
struct RtcpReportBlock {
  ...
  // Convenience helper to convert the given |delay| to the correct timebase and
  // clamp to its valid range.
  void SetDelaySinceLastReport(platform::Clock::duration delay);
