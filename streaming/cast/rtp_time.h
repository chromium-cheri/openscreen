...
#ifndef STREAMING_CAST_COMMON_RTP_TIME_H_
#define STREAMING_CAST_COMMON_RTP_TIME_H_
...
class RtpTimeDelta : public ExpandedValueBase<int64_t, RtpTimeDelta> {
 public:
  ...
  Duration ToDuration(int rtp_timebase) const {
    ...
    static constexpr Duration kOneSecond =
  ...
  // RtpTimeDelta.
  template <typename Duration>
  static RtpTimeDelta FromDuration(Duration duration, int rtp_timebase) {
    static constexpr Duration kOneSecond =
        std::chrono::duration_cast<Duration>(std::chrono::seconds(1));
...
class RtpTimeTicks : public ExpandedValueBase<int64_t, RtpTimeTicks> {
 public:
  ...
  // RtpTimeTicks.
  template <typename Duration>
  static RtpTimeTicks FromTimeSinceOrigin(Duration time_since_origin,
                                          int rtp_timebase) {
    return RtpTimeTicks() +
...
#endif  // STREAMING_CAST_COMMON_RTP_TIME_H_
