...
#ifndef STREAMING_CAST_RECEIVER_DEMO_SDL_PLAYER_BASE_H_
#define STREAMING_CAST_RECEIVER_DEMO_SDL_PLAYER_BASE_H_
...
class SDLPlayerBase : public Receiver::Consumer, public Decoder::Client {
 ...
 protected:
  ...
  SDLPlayerBase(platform::ClockNowFunctionPtr now_function,
  ...
  // If an error occurs, OnFatalError() should be called, and the return value
  // will be ignored.
  virtual platform::Clock::time_point RenderNextFrame(
...
#endif  // STREAMING_CAST_RECEIVER_DEMO_SDL_PLAYER_BASE_H_
