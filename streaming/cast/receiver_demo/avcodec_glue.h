...
#ifndef STREAMING_CAST_RECEIVER_DEMO_AVCODEC_GLUE_H_
#define STREAMING_CAST_RECEIVER_DEMO_AVCODEC_GLUE_H_
...
#endif  // STREAMING_CAST_RECEIVER_DEMO_AVCODEC_GLUE_H_
