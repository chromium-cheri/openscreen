...
#ifndef STREAMING_CAST_RECEIVER_DEMO_SDL_GLUE_H_
#define STREAMING_CAST_RECEIVER_DEMO_SDL_GLUE_H_
...
class SDLEventLoopProcessor {
 public:
  SDLEventLoopProcessor(platform::TaskRunner* task_runner,
...
#endif  // STREAMING_CAST_RECEIVER_DEMO_SDL_GLUE_H_
