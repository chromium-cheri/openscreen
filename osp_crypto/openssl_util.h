...
#ifndef OSP_CRYPTO_OPENSSL_UTIL_H_
#define OSP_CRYPTO_OPENSSL_UTIL_H_
...
class ScopedOpenSSLSafeSizeBuffer {
 ...
 private:
  ...
  OSP_DISALLOW_COPY_AND_ASSIGN(ScopedOpenSSLSafeSizeBuffer);
};
...
#endif  // OSP_CRYPTO_OPENSSL_UTIL_H_
