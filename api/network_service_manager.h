...
class NetworkServiceManager final {
 ...
 private:
  NetworkServiceManager(MdnsScreenListener* mdns_listener,
                        MdnsScreenPublisher* mdns_publisher,
                        ScreenConnectionClient* connection_client,
                        ScreenConnectionServer* connection_server);
  ...
  MdnsScreenListener *const mdns_listener_;
  MdnsScreenPublisher *const mdns_publisher_;
  ScreenConnectionClient *const connection_client_;
  ScreenConnectionServer *const connection_server_;
};
