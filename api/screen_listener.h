...
struct ScreenListenerErrorInfo {
 public:
  ...
  ScreenListenerErrorInfo(ScreenListenerErrorInfo&& other);
  ~ScreenListenerErrorInfo();

  ScreenListenerErrorInfo& operator=(const ScreenListenerErrorInfo& other);
  ScreenListenerErrorInfo& operator=(ScreenListenerErrorInfo&& other);
...
class ScreenListener {
 public:
  ...
  // Returns true if state() != kStopped.
  virtual bool Stop() = 0;
  ...
  // Resumes listening.  Returns true if state() == kSuspended.
