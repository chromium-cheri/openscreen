...
class ScreenPublisherImpl final : public ScreenPublisher {
 public:
  class Delegate {
   ...
   protected:
    void SetState(ScreenPublisherState state) { publisher_->SetState(state); }
  ...
  ScreenPublisherImpl(ScreenPublisherObserver* observer, Delegate* delegate);
