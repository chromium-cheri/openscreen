...
Error WritePresentationInitiationResponse(
  ...
  return WriteMessage(response, msgs::EncodePresentationInitiationResponse,
                      connection);
}
...
Error WritePresentationConnectionOpenResponse(
    ...
    ProtocolConnection* connection) {
  return WriteMessage(response, msgs::EncodePresentationConnectionOpenResponse,
                      connection);
}
...
Error WritePresentationTerminationEvent(
    ...
    ProtocolConnection* connection) {
  return WriteMessage(event, msgs::EncodePresentationTerminationEvent,
                      connection);
}
...
Error WritePresentationTerminationResponse(
    ...
    ProtocolConnection* connection) {
  return WriteMessage(response, msgs::EncodePresentationTerminationResponse,
                      connection);
}
...
Error WritePresentationUrlAvailabilityResponse(
    ...
    ProtocolConnection* connection) {
  return WriteMessage(response, msgs::EncodePresentationUrlAvailabilityResponse,
                      connection);
}
  ...
  switch (message_type) {
    ...
    case msgs::Type::kPresentationInitiationRequest: {
      ...
      const bool starting = delegate_->StartPresentation(
          Connection::PresentationInfo{request.presentation_id, request.url},
    ...
    case msgs::Type::kPresentationConnectionOpenRequest: {
      ...
      if (started_presentations_.find(request.presentation_id) ==
    ...
    case msgs::Type::kPresentationTerminationRequest: {
      ...
      auto presentation_entry =
          started_presentations_.find(request.presentation_id);
