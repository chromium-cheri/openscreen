...
TEST_F(ConnectionTest, ConnectAndSend) {
  ...
  Connection controller(Connection::Info{id, url},
                        Connection::Role::kController,
                        &mock_controller_delegate);
  Connection receiver(Connection::Info{id, url}, Connection::Role::kReceiver,
                      &mock_receiver_delegate);

  EXPECT_EQ(id, controller.presentation_id());
  EXPECT_EQ(url, controller.presentation_url());
  EXPECT_EQ(id, receiver.presentation_id());
  EXPECT_EQ(url, receiver.presentation_url());
  ...
  receiver.SendBinary(binary_response);
