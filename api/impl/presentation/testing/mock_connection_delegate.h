...
#ifndef API_IMPL_PRESENTATION_TESTING_MOCK_CONNECTION_DELEGATE_H_
#define API_IMPL_PRESENTATION_TESTING_MOCK_CONNECTION_DELEGATE_H_
...
#endif  // API_IMPL_PRESENTATION_TESTING_MOCK_CONNECTION_DELEGATE_H_
