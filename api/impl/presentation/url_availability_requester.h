...
class UrlAvailabilityRequester {
 public:
  ...
  void AddReceiver(const ReceiverInfo& info);
  void ChangeReceiver(const ReceiverInfo& info);
  void RemoveReceiver(const ReceiverInfo& info);
