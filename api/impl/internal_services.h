...
class InternalServices {
 ...
 private:
  ...
  void RegisterMdnsSocket(platform::UdpSocketIPv4Ptr socket);
  void RegisterMdnsSocket(platform::UdpSocketIPv6Ptr socket);
  void DeregisterMdnsSocket(platform::UdpSocketIPv4Ptr socket);
  void DeregisterMdnsSocket(platform::UdpSocketIPv6Ptr socket);
