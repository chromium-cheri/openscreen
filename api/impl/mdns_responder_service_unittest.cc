...
class FakeMdnsResponderAdapterFactory final
 ...
 public:
  ...
  std::unique_ptr<mdns::MdnsResponderAdapter> Create() override {
    auto mdns = absl::make_unique<FakeMdnsResponderAdapter>();
