...
class Controller {
 public:
  ...
  // maintained by the ReceiverListener.  Returns a positive integer id that
  ...
  // Requests that a new presentation be created on |receiver_id| using
  ...
  // on the receiver with |receiver_id|, with the result passed to |delegate|.
