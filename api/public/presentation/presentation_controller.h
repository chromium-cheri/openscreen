...
class Controller final : public ServiceListener::Observer {
 public:
  ...
  // TODO(jophba): delete when no longer a singleton
  void Init();
  void Deinit();
  ...
  // TODO(jophba): Remove singleton pattern, and have per profile info.
  // Esp. for any case where we need to segregate information
