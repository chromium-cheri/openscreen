...
// This contains canonical information about a specific Open Screen service found on the
...
struct ServiceInfo {
  ...
  // The network endpoints to create a new connection to the Open Screen service.
