...
struct ServiceInfo {
  ...
  ServiceInfo(const ServiceInfo&) noexcept = default;

  ServiceInfo& operator=(ServiceInfo&&) noexcept = default;
  ServiceInfo& operator=(const ServiceInfo&) noexcept = default;
