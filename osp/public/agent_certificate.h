...
// This class cetrally deal with agent certificate.
class AgentCertificate {
 public:
  ...
  // Load an agent certificate from a file identified by |filename|.
  ...
  // Load a private key from a file identified by |filename|.
