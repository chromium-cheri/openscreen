...
void ListenerDemo() {
  ...
  std::unique_ptr<platform::NetworkRunnerFactory> network_runner_factory =
      platform::NetworkRunnerFactory::Create();
  network_runner_factory->CreateNetworkRunner();
  platform::NetworkRunner* network_runner = network_runner_factory->Get();
