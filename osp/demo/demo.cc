...
void ListenerDemo() {
  ...
  auto network_runner_factory = platform::NetworkRunnerFactory::Create();
  ...
  auto mdns_listener = MdnsServiceListenerFactory::Create(
      listener_config, &listener_observer, network_runner_factory->Get());
  ...
  auto connection_client = ProtocolConnectionClientFactory::Create(
      &demuxer, &client_observer, network_runner_factory->Get());
...
void PublisherDemo(absl::string_view friendly_name) {
  ...
  auto mdns_publisher = MdnsServicePublisherFactory::Create(
      publisher_config, &publisher_observer, network_runner_factory->Get());
  ...
  auto connection_server = ProtocolConnectionServerFactory::Create(
      server_config, &demuxer, &server_observer, network_runner_factory->Get());
