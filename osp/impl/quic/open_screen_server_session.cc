...
OpenScreenServerSession::OpenScreenServerSession(
    ...
    std::unique_ptr<quic::QuicCryptoServerConfig> quic_crypto_server_config,
    ...
    : OpenScreenSessionBase(std::move(connection),
                            ...
                            config,
                            supported_versions),
      quic_crypto_server_config_(std::move(quic_crypto_server_config)),
...
OpenScreenServerSession::CreateCryptoStream() {
  return CreateCryptoServerStream(quic_crypto_server_config_.get(),
