...
#include "third_party/quiche/src/quiche/common/quiche_random.h"
#include "third_party/quiche/src/quiche/quic/core/crypto/quic_compressed_certs_cache.h"
...
#include "third_party/quiche/src/quiche/quic/platform/api/quic_default_proof_providers.h"
#include "third_party/quiche/src/quiche/quic/platform/api/quic_socket_address.h"
#include "third_party/quiche/src/quiche/quic/tools/fake_proof_verifier.h"
...
QuicConnectionFactoryImpl::QuicConnectionFactoryImpl(TaskRunner& task_runner,
  ...
  if (is_for_client) {
    client_config = std::make_unique<quic::QuicCryptoClientConfig>(
    ...
    server_config = std::make_unique<quic::QuicCryptoServerConfig>(
        ...
        quic::CreateDefaultProofSource(), quic::KeyExchangeSource::Default());
  }
}
