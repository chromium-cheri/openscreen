...
FakeQuicBridge::FakeQuicBridge(FakeTaskRunner& task_runner,
  ...
  ServiceConfig client_config = {.connection_endpoints = {IPEndpoint()}};
  ...
  quic_client->instance_infos_.emplace(
      kInstanceID, QuicClient::InstanceInfo{kFingerprint, kReceiverEndpoint});
