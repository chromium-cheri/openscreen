 ...
 public:
  class Delegate {
   public:
    ...
    virtual QuicStream::Delegate& GetStreamDelegate(uint64_t instance_id,
  ...
  explicit QuicConnection(const std::string& instacne_name, Delegate& delegate)
      : instance_name_(instacne_name), delegate_(delegate) {}
