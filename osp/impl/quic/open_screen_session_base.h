...
class OpenScreenSessionBase : public quic::QuicSession {
 public:
  ...
  // For debug.
  size_t SendCryptoData(quic::EncryptionLevel level,
                        size_t write_length,
                        quic::QuicStreamOffset offset,
                        quic::TransmissionType type) override {
    OSP_LOG_INFO << "QuicSession::SendCryptoData";
    return quic::QuicSession::SendCryptoData(level, write_length, offset, type);
  }
