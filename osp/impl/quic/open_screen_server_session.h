...
#include "third_party/quiche/src/quiche/quic/core/quic_crypto_server_stream_base.h"
...
class OpenScreenServerSession : public OpenScreenSessionBase {
 ...
 private:
  // Config for QUIC crypto server stream.
  const quic::QuicCryptoServerConfig* quic_crypto_server_config_;
