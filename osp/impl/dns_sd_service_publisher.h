...
#ifndef OSP_IMPL_DNS_SD_SERVICE_PUBLISHER_H_
#define OSP_IMPL_DNS_SD_SERVICE_PUBLISHER_H_
...
class DnsSdServicePublisher final : public ServicePublisherImpl::Delegate,
                                    openscreen::discovery::ReportingClient {
 public:
  DnsSdServicePublisher(ServicePublisher::Observer* observer,
                        openscreen::TaskRunner* task_runner);
  ~DnsSdServicePublisher() override;
 ...
 private:
  DnsSdServicePublisher(const DnsSdServicePublisher&) = delete;
  DnsSdServicePublisher(DnsSdServicePublisher&&) noexcept = delete;
  ...
  SerialDeletePtr<openscreen::discovery::DnsSdService> dns_sd_service_;

  using OspServicePublisher =
      openscreen::discovery::DnsSdServicePublisher<ServicePublisher::Config>;

  std::unique_ptr<OspServicePublisher> dns_sd_publisher_;
};

}  // namespace osp
}  // namespace openscreen

#endif  // OSP_IMPL_DNS_SD_SERVICE_PUBLISHER_H_
