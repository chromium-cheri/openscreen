...
void BrowseDemo(RuntimeContext* runtime_context,
...
int main(int argc, char** argv) {
  ...
  openscreen::RuntimeContext runtime_context(task_runner_thread.task_runner());

  openscreen::BrowseDemo(&runtime_context, labels[0], labels[1],
                         service_instance);
