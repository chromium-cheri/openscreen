...
vars = {
 ...
 # Fetch clang-tidy into the same bin/ directory as our clang binary.
  ...
  # If you change this, also make sure to also update the buildtools revision
  # so that the revision in //buildtools/deps_revisions.gni matches.
  'libcxx_revision':       '28aa23ffb4c7344914a5b4ac7169f12e5a12333f',
  'libcxxabi_revision':    'a46df1f416d9bbaa25bceaa684418f94ec3935b2',
}
...
deps = {
  ...
  'buildtools': {
    'url': Var('chromium_git') + '/chromium/src/buildtools' +
      '@' + 'd8688b9036d46d14ef1f6fc26bcbb1da2b17f897',
  },
  ...
  'build': {
    'url': Var('chromium_git') + '/chromium/src/build' +
      '@' + '0b7a0198da6202822e3c9d934327e390760459f1',
