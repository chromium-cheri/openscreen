...
TEST(VerifyCastDeviceCertTest, Fugu) {
  RunTest(CastCertError::kNone, "-6394818897508095075",
          CastDeviceCertPolicy::kNone, TEST_DATA_PREFIX "certificates/fugu.pem",
          AprilFirst2016(), TRUST_STORE_BUILTIN, "");
}
...
TEST(VerifyCastDeviceCertTest, CastRootCa) {
  RunTest(CastCertError::kErrCertsRestrictions, "", CastDeviceCertPolicy::kNone,
...
TEST(VerifyCastDeviceCertTest, ChromecastGen2InvalidTime) {
  ...
  RunTest(CastCertError::kNone, "3ZZAK6 FA8FCA3F0D35",
          CastDeviceCertPolicy::kNone, kCertsFile, AprilFirst2016(),
          TRUST_STORE_BUILTIN, "");

  // Use a time before notBefore.
  RunTest(CastCertError::kErrCertsDateInvalid, "", CastDeviceCertPolicy::kNone,
...
TEST(VerifyCastDeviceCertTest, ExpiredTrustAnchor) {
  ...
  RunTest(CastCertError::kNone, "CastDevice", CastDeviceCertPolicy::kNone,
...
TEST(VerifyCastDeviceCertTest, PoliciesIcaAnypolicyLeafAnypolicy) {
  RunTest(CastCertError::kNone, "Leaf", CastDeviceCertPolicy::kNone,
          TEST_DATA_PREFIX
