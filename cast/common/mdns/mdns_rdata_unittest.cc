...
TEST(MdnsRdataTest, ARecordRdata) {
  ...
  auto parse_result = openscreen::IPAddress::Parse("8.8.8.8");
  ASSERT_TRUE(parse_result);
  openscreen::IPAddress address(parse_result.MoveValue());
  ARecordRdata rdata;
...
TEST(MdnsRdataTest, AAAARecordRdata) {
  ...
  auto parse_result =
      openscreen::IPAddress::Parse("FE80:0000:0000:0000:0202:B3FF:FE1E:8329");
  ASSERT_TRUE(parse_result);
  openscreen::IPAddress address(parse_result.MoveValue());
