...
const MdnsRecord& MdnsRecordTracker::TrackedRecord() const {
  OSP_DCHECK(task_runner_->IsRunningOnTaskRunner());
...
const MdnsQuestion& MdnsQuestionTracker::TrackedQuestion() const {
  OSP_DCHECK(task_runner_->IsRunningOnTaskRunner());
...
//           record, sender_, task_runner_, now_function_, random_delay_,
