...
// name: an owner name, i.e., the name of the node to which this resource record
// pertains.
// type: 2 bytes network-order containing one of the RR TYPE codes.
// class: 2 bytes network-order containing one of the RR CLASS codes.
// ttl: 4 bytes network-order signed integer that specifies the time interval
// that the resource record may be cached before the source of the information
