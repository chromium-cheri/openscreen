...
class RawRecordRdata {
 public:
  ...
  void set_rdata(std::vector<uint8_t> rdata) { rdata_ = std::move(rdata); }
...
class SrvRecordRdata {
 public:
  ...
  void set_target(DomainName target) { target_ = std::move(target); }
...
class ARecordRdata {
 public:
  ...
  void set_ipv4_address(IPAddress address);
...
class AAAARecordRdata {
 public:
  ...
  void set_ipv6_address(IPAddress address);
...
class PtrRecordRdata {
 public:
  ...
  void set_ptr_domain(DomainName name) { ptr_domain_ = std::move(name); }
...
class TxtRecordRdata {
 public:
  ...
  void set_texts(std::vector<std::string> texts) { texts_ = std::move(texts); }
