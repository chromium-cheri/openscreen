...
// TODO(https://crbug.com/openscreen/47): Figure out the exact size that the senders are using and
// sync with them. We want to verify that we are using the same maximum
// packet size. The spec also suggests keeping all UDP messsages below
