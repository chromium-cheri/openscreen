...
// - Shutdown of the E2E test causes a DCHECk failure because the MdnsPublisher
//   instance is owned by this thread. This will be fixed as part of CL
//   https://chromium-review.googlesource.com/c/openscreen/+/2024453
TEST(DiscoveryE2ETest, Test) {
  ...
  auto discovery_config = openscreen::cast::GetConfigSettings(false);
  openscreen::cast::FailOnErrorReporting reporting_client;
  ...
  auto multi_address = openscreen::cast::GetInfoV4V6();
