...
#ifndef CAST_COMMON_PUBLIC_AGENT_CONFIG_H_
#define CAST_COMMON_PUBLIC_AGENT_CONFIG_H_
...
struct AgentConfig {
  ...
  openscreen::cast_streaming::RtpTimeTicks rtp_timebase = 90000;
...
#endif  // CAST_COMMON_PUBLIC_AGENT_CONFIG_H_
