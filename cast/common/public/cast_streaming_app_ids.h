...
//
// TODO(b/204583004): Use absl::string_view instead of std::string so that these
// comparisons can be made constexpr.
...
// Returns true only if |app_id| matches any Cast application ID.
