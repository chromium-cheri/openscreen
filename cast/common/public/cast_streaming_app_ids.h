...
constexpr bool IsCastStreamingAudioVideoAppId(const std::string& app_id) {
  return app_id == GetCastStreamingAudioVideoAppId();
}

constexpr bool IsCastStreamingAudioOnlyAppId(const std::string& app_id) {
...
constexpr bool IsCastStreamingAppId(const std::string& app_id) {
