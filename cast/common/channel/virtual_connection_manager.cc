...
uint32_t VirtualConnectionManager::RemoveConnectionsByLocalId(
...
uint32_t VirtualConnectionManager::RemoveConnectionsBySocketId(
    uint32_t socket_id,
    VirtualConnection::CloseReason reason) {
...
absl::optional<std::reference_wrapper<const VirtualConnection::AssociatedData>>
VirtualConnectionManager::HasConnection(
