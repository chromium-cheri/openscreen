...
TEST_F(VirtualConnectionRouterTest, HandlesConnectionMessagesAsSpecialCase) {
  ...
  class MockConnectionNamespaceHandler final
   ...
   public:
    MockConnectionNamespaceHandler(VirtualConnectionRouter* vc_router,
                                   VirtualConnectionPolicy* vc_policy)
        : ConnectionNamespaceHandler(vc_router, vc_policy) {}
  ...
  MockConnectionNamespaceHandler connection_handler(&local_router_, &policy);
