...
#ifndef CAST_SENDER_PUBLIC_SENDER_CONFIG_H_
#define CAST_SENDER_PUBLIC_SENDER_CONFIG_H_
...
// optional.
struct SenderConfig : public AgentConfig {
  ...
  // use by the receiver.
  std::pair<std::chrono::microseconds, std::chrono::microseconds> playout_limits {};

  // The initial playout delay for animated content. Must be in the range
  // specified by playout_limits.
  std::chrono::microseconds animated_playout_delay = 0;
...
#endif  // CAST_SENDER_PUBLIC_SENDER_CONFIG_H_
