...
TEST_F(CastAppDiscoveryServiceImplTest, StartObservingAvailability) {
  ...
  platform_handler_.AddOrUpdateReceiver(receiver_, socket_->socket_id());
  app_discovery_service_.AddOrUpdateReceiver(receiver_);
  ...
  subscription1.reset();
  platform_handler_.RemoveReceiver(receiver_);
...
TEST_F(CastAppDiscoveryServiceImplTest,
  ...
  platform_handler_.AddOrUpdateReceiver(receiver2, socket2->socket_id());
  app_discovery_service_.AddOrUpdateReceiver(receiver2);
}
