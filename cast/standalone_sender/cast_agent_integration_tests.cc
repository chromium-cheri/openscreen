...
//         task_runner_,
//         TlsConnectionFactory::CreateFactory(sender_factory_.get(),
//         task_runner_)
//             .release());
...
//   // Cast socket sender components, used in conjuction to mock a Libcast
//   sender. VirtualConnectionManager sender_vc_manager_;
