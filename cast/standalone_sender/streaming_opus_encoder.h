...
// interleaved-floats audio samples to a Sender. Either monaural or stereo sound
// is supported.
class StreamingOpusEncoder {
 public:
  // Constructs the encoder for monaural or stereo sound, dividing the stream of
 ...
 private:
  ...
  // The number of monaural/stereo tuples currently queued in the |input_|
  // buffer. Multiply by |num_channels_| to get the number of array elements.
