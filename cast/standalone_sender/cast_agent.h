...
#ifndef CAST_STANDALONE_SENDER_CAST_AGENT_H_
#define CAST_STANDALONE_SENDER_CAST_AGENT_H_
...
class CastAgent final : public SenderSocketFactory::Client,
 ...
 public:
  explicit CastAgent(TaskRunner* task_runner);
  ~CastAgent();
...
#endif  // CAST_STANDALONE_SENDER_CAST_AGENT_H_
