...
#include "third_party/aomedia/src/aom/aom_encoder.h"
#include "third_party/aomedia/src/aom/aom_image.h"
...
class StreamingAv1Encoder {
 public:
  // Configurable parameters passed to the StreamingAv1Encoder constructor.
  struct Parameters {
