...
#ifndef CAST_API_FRAME_SENDER_CONFIG_H_
#define CAST_API_FRAME_SENDER_CONFIG_H_
...
struct FrameSenderConfig : public FrameAgentConfig {
  ...
  // use by the receiver.
  std::pair<Clock::duration, Clock::duration>
      playout_limits;
  ...
  // Coded specific parameters. Since
  // we support arbitrary codecs,
...
#endif  // CAST_API_FRAME_SENDER_CONFIG_H_
