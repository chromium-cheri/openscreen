...
// TODO(crbug.com/openscreen/86): Remove this hack once the Mac buildbot uses a
// reasonably-recent compiler version.
...
// reasonably-recent compiler version.
#if __clang_major__ < 6
#pragma clang diagnostic pop  // Enable "-Wmissing-braces" from here onwards.
#endif
