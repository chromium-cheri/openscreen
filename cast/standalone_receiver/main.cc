...
int RunStandaloneReceiver(int argc, char* argv[]) {
  ...
  OSP_LOG_INFO << "Note: compiled without external libs. The dummy player will "
                  "be linked "
                  "and no video decoding will occur. If this is not desired, "
                  "install the "
                  "required external libraries. For more information, see: "
                  "//build/config/external_libraries.md.";
#endif
