...
//
// In a production environment, the AES keys and IVs should be generated from a
...
const cast::streaming::SessionConfig kSampleAudioAnswerConfig{
    ...
    /* .rtp_timebase = */ 48000,
    /* .channels = */ 2,
    /* .aes_secret_key = */ kDemoAudioAesKey,
    /* .aes_iv_mask = */ kDemoAudioCastIvMask,
};
...
const cast::streaming::SessionConfig kSampleVideoAnswerConfig{
    ...
    /* .channels = */ 1,
    /* .aes_secret_key = */ kDemoVideoAesKey,
    /* .aes_iv_mask = */ kDemoVideoCastIvMask,
};
