...
#ifndef CAST_STREAMING_RECEIVER_PREFERENCES_H_
#define CAST_STREAMING_RECEIVER_PREFERENCES_H_
...
class ReceiverPreferences {
 public:
  ReceiverPreferences();
  ReceiverPreferences(std::vector<VideoCodec> video_codecs,
  ...
  ReceiverPreferences(ReceiverPreferences&&) noexcept;
  ReceiverPreferences(const ReceiverPreferences&);
  ReceiverPreferences& operator=(ReceiverPreferences&&) noexcept;
  ReceiverPreferences& operator=(const ReceiverPreferences&);

  // Returns true if all configurations supported by |other| are also
  // supported by this instance.
  //  bool IsSupersetOf(const ReceiverPreferences& other) const;
...
#endif  // CAST_STREAMING_RECEIVER_PREFERENCES_H_
