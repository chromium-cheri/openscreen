...
ByteView Sender::GetRtcpPacketForImmediateSend(Clock::time_point send_time,
                                               ByteView buffer) {
...
ByteView Sender::GetRtpPacketForImmediateSend(Clock::time_point send_time,
                                              ByteView buffer) {
  ...
  const ByteView result = rtp_packetizer_.GeneratePacket(
