...
class ReceiverSession final : public Environment::SocketSubscriber {
 public:
  ...
  struct Display {
    ...
    bool SupportsAllAllowedBy(const Display& other) const;
  ...
  struct AudioLimits {
    // Returns true if all configurations supported by |other| are also
    // supported by this instance.
    bool SupportsAllAllowedBy(const AudioLimits& other) const;
  ...
  struct VideoLimits {
    // Returns true if all configurations supported by |other| are also
    // supported by this instance.
    bool SupportsAllAllowedBy(const VideoLimits& other) const;
  ...
  struct RemotingPreferences {
    // Returns true if all configurations supported by |other| are also
    // supported by this instance.
    bool SupportsAllAllowedBy(const RemotingPreferences& other) const;
  ...
  struct Preferences {
    ...
    // Returns true if all configurations supported by |other| are also
    // supported by this instance.
    bool SupportsAllAllowedBy(const Preferences& other) const;
