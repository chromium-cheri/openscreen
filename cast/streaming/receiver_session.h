...
class ReceiverSession final : public Environment::Subscriber {
 public:
  ...
  // Environment::Subscriber event callbacks.
 ...
 private:
  ...
  // UDP socket to be initialized. In this case, the receivers and the answer
