  ...
  class ConfiguredReceivers {
   public:
    ConfiguredReceivers(std::unique_ptr<Receiver> audio_receiver,
                        SessionConfig audio_receiver_config,
                        std::unique_ptr<Receiver> video_receiver,
                        SessionConfig video_receiver_config);
