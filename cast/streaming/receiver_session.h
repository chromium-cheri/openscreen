...
class ReceiverSession final : public Environment::SocketSubscriber {
 public:
  ...
  using RemotingPreferences = openscreen::cast::RemotingPreferences;
  using Preferences = openscreen::cast::ReceiverPreferences;
 ...
 private:
  ...
  const ReceiverPreferences preferences_;
