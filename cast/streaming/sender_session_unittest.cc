...
//   MOCK_METHOD(void,
//               OnNegotiated,
//               (const SenderSession*, SenderSession::ConfiguredSenders),
//               (override));
//   MOCK_METHOD(void,
//               OnSendersDestroying,
//               (const SenderSession*, SendersDestroyingReason),
//               (override));
//   MOCK_METHOD(void, OnError, (const SenderSession*, Error error),
//   (override));
// };
...
//         .WillByDefault(
//             Return(IPEndpoint{IPAddress::Parse("127.0.0.1").value(),
//             12345}));
//     return environment_;
//   }
...
// TEST_F(SenderSessionTest, HandlesMalformedOffer) {
...
// TEST_F(SenderSessionTest, HandlesImproperlyFormattedOffer) {
//   EXPECT_CALL(client_,
...
// TEST_F(SenderSessionTest, HandlesNullOffer) {
