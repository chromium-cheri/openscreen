...
#ifndef CAST_STREAMING_PUBLIC_CAST_STREAMING_APP_IDS_H_
#define CAST_STREAMING_PUBLIC_CAST_STREAMING_APP_IDS_H_
...
std::string GetCastStreamingAudioVideoAppId();

// Returns the app ID for the audio-only streaming receiver.
std::string GetCastStreamingAudioOnlyAppId();

}  // namespace cast
}  // namespace openscreen

#endif  // CAST_STREAMING_PUBLIC_CAST_STREAMING_APP_IDS_H_
