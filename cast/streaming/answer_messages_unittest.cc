...
TEST(AnswerMessagesTest, ProperlyPopulatedAnswerSerializesProperly) {
  ...
  EXPECT_DOUBLE_EQ(min_dimensions["frameRate"].asDouble(), 30.0);
  ...
  EXPECT_DOUBLE_EQ(max_dimensions["frameRate"].asDouble(), 144.0);
  ...
  EXPECT_DOUBLE_EQ(dimensions["frameRate"].asDouble(), 30.0);
