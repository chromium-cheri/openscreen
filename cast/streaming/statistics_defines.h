...
struct FrameEvent {
  ...
  constexpr FrameEvent(const FrameEvent& other) = default;
  constexpr FrameEvent(FrameEvent&& other) noexcept = default;
...
struct PacketEvent {
  ...
  constexpr PacketEvent(const PacketEvent& other) = default;
  constexpr PacketEvent(PacketEvent&& other) noexcept = default;
