...
class CompoundRtcpBuilder {
 public:
  ...
  ByteView BuildPacket(Clock::time_point send_time, ByteView buffer);
 ...
 private:
  ...
  void AppendReceiverReportPacket(ByteView* buffer);
  void AppendReceiverReferenceTimeReportPacket(Clock::time_point send_time,
                                               ByteView* buffer);
  void AppendPictureLossIndicatorPacket(ByteView* buffer);
  void AppendCastFeedbackPacket(ByteView* buffer);
  int AppendCastFeedbackLossFields(ByteView* buffer);
  void AppendCastFeedbackAckFields(ByteView* buffer);
