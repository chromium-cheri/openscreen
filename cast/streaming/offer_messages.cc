...
bool CodecParameterIsValid(VideoCodec codec,
  ...
  switch (codec) {
    case VideoCodec::kVp8:
      return stringutilstarts_with(codec_parameter, "vp08");
    case VideoCodec::kVp9:
      return stringutilstarts_with(codec_parameter, "vp09");
    case VideoCodec::kAv1:
      return stringutilstarts_with(codec_parameter, "av01");
    case VideoCodec::kHevc:
      return stringutilstarts_with(codec_parameter, "hev1");
    case VideoCodec::kH264:
      return stringutilstarts_with(codec_parameter, "avc1");
...
bool CodecParameterIsValid(AudioCodec codec,
  ...
  switch (codec) {
    case AudioCodec::kAac:
      return stringutilstarts_with(codec_parameter, "mp4a.");
