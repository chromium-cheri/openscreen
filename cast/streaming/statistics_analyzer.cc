...
const size_t kMaxRecentFrameInfoMapSize = 100;
...
StatisticsAnalyzer::FrameStatsAggregate::FrameStatsAggregate() = default;
StatisticsAnalyzer::FrameStatsAggregate::~FrameStatsAggregate() = default;
StatisticsAnalyzer::PacketStatsAggregate::PacketStatsAggregate() = default;
StatisticsAnalyzer::PacketStatsAggregate::~PacketStatsAggregate() = default;
StatisticsAnalyzer::LatencyStatsAggregate::LatencyStatsAggregate() = default;
StatisticsAnalyzer::LatencyStatsAggregate::~LatencyStatsAggregate() = default;
StatisticsAnalyzer::FrameInfo::FrameInfo() = default;
StatisticsAnalyzer::FrameInfo::~FrameInfo() = default;
StatisticsAnalyzer::PacketInfo::PacketInfo() = default;
StatisticsAnalyzer::PacketInfo::~PacketInfo() = default;
StatisticsAnalyzer::SessionStats::SessionStats() = default;
StatisticsAnalyzer::SessionStats::~SessionStats() = default;
