...
TEST_F(StatisticsCollectorTest, CanCollectPacketEvents) {
  constexpr PacketEvent kEventOne(
      FrameId(5000), StatisticsEventType::kPacketSentToNetwork,
      StatisticsEventMediaType::kAudio, RtpTimeTicks(47474838), 1234u,
      Clock::time_point(milliseconds(12455680)),
      Clock::time_point(milliseconds(12455685)), 123u, 456u);

  constexpr PacketEvent kEventTwo(
      FrameId(20000), StatisticsEventType::kPacketSentToNetwork,
      StatisticsEventMediaType::kVideo, RtpTimeTicks(4747900), 553u,
      Clock::time_point(milliseconds(12455880)),
      Clock::time_point(milliseconds(12455889)), 124u, 456u);
...
TEST_F(StatisticsCollectorTest, CanCollectFrameEvents) {
  constexpr FrameEvent kEventOne(
      FrameId(1), StatisticsEventType::kFrameAckReceived,
      StatisticsEventMediaType::kVideo, RtpTimeTicks(1233),
      /* size= */ 0, Clock::time_point(milliseconds(12345678)),
  ...
  constexpr FrameEvent kEventTwo(
      FrameId(2), StatisticsEventType::kFramePlayedOut,
      StatisticsEventMediaType::kAudio, RtpTimeTicks(1733),
      /* size= */ 6000, Clock::time_point(milliseconds(12455680)),
