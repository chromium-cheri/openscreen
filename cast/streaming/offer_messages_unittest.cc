...
TEST(OfferTest, CanParseValidOffer) {
  ...
  EXPECT_EQ(RtpProfile::kCast, vs_one.stream.rtp_profile);
  EXPECT_EQ(127, vs_one.stream.rtp_payload_type);
  EXPECT_EQ(19088743u, vs_one.stream.ssrc);
  EXPECT_EQ("60000/1000", vs_one.max_frame_rate);
  EXPECT_EQ(90000, vs_one.stream.time_base);
  ...
  EXPECT_EQ(RtpProfile::kCast, vs_two.stream.rtp_profile);
  EXPECT_EQ(127, vs_two.stream.rtp_payload_type);
  EXPECT_EQ(19088743u, vs_two.stream.ssrc);
  EXPECT_EQ("30000/1001", vs_two.max_frame_rate);
  EXPECT_EQ(90000, vs_two.stream.time_base);
  ...
  EXPECT_EQ(1u, resolutions_two.size());
  ...
  EXPECT_EQ(RtpProfile::kCast, as.stream.rtp_profile);
  EXPECT_EQ(97, as.stream.rtp_payload_type);
