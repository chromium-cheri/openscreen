...
ByteView CompoundRtcpBuilder::BuildPacket(Clock::time_point send_time,
                                          ByteView buffer) {
  ...
  return ByteView(packet_begin, packet_end - packet_begin);
}

void CompoundRtcpBuilder::AppendReceiverReportPacket(ByteView* buffer) {
...
void CompoundRtcpBuilder::AppendPictureLossIndicatorPacket(ByteView* buffer) {
  RtcpCommonHeader header;
...
void CompoundRtcpBuilder::AppendCastFeedbackPacket(ByteView* buffer) {
  ...
  ByteView space_for_header = ReserveSpace(kRtcpCommonHeaderSize, buffer);
...
int CompoundRtcpBuilder::AppendCastFeedbackLossFields(ByteView* buffer) {
...
void CompoundRtcpBuilder::AppendCastFeedbackAckFields(ByteView* buffer) {
