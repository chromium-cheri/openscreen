...
enum class LogLevel {
  ...
  // problems. This is also used for general console messaging in OpenScreen's
  ...
  // operational failure so serious that OpenScreen will soon call Break() to
...
// Whenever |level| is kFatal, OpenScreen will call Break() immediately after
// this returns.
...
// Aborts the current process. OpenScreen will assume this method will not
// return. Some embedders might provide infrastructure for performing "dumps"
// consisting of thread stack traces, and other relevant debugging information
// at this time.
[[noreturn]] void Break();
...
// Convenience macros and inline code that OpenScreen code uses to invoke the
