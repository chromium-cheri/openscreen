...
// library use begins, and the ShutDown method should be called before exiting
// the application to ensure that no objects are leaked.
// NOTE: All public methods in implementations of PlatformClient are expected to
// be thread-safe.
class PlatformClient {
 public:
  ...
  // Shuts down and deleted the PlatformClient instance currently stored as a
