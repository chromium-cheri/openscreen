...
// For proper behavior of the OpenScreen library, the Clock implementation may
// not have worse resolution than this.
using kRequiredResolution = std::ratio<1, 10000>;  // 10000 parts per second.
