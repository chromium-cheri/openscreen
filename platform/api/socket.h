 ...
 public:
  ...
  class Delegate {
   public:
    ...
    virtual void OnMessage(Socket* socket, const SocketMessage& message) = 0;
  ...
  static ErrorOr<SocketUniquePtr> Create(Type type,
                                         Version version,
                                         std::string id,
                                         Delegate* delegate);
  ...
  ErrorOr<SocketMessage> ReceiveMessage();
  ...
  Error SendMessage(const SocketMessage& message);
