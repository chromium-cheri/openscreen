...
class UdpSocket {
 public:
  ...
  // Constants used to specify how we want pakcets sent from this socket.
  static uint8_t kDscpLowPriority;
  static uint8_t kDscpLowLatency;
  static uint8_t kDscpMaxThroughput;
  static uint8_t kDscpMaxReliability;
