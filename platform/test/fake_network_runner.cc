...
void FakeNetworkRunner::RunUntilStopped() {
  OSP_DCHECK(false) << "don't call RunUntilStopped() in testing";
}

void FakeNetworkRunner::RequestStopSoon() {
  OSP_DCHECK(false) << "don't call RequestStopSoon() in testing";
}
