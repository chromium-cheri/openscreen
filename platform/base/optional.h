...
// Tag type used for NullOptType construction.
struct NullOptTypeInit {
  NullOptTypeInit() = default;
};

struct NullOptType {
  // Purposefully not default-constructible.
  explicit constexpr NullOptType(NullOptTypeInit) noexcept {}
};

constexpr NullOptType kNullOpt{NullOptTypeInit()};
...
class Optional {
 public:
  ...
  explicit constexpr Optional(NullOptType) noexcept {}
