...
#ifndef PLATFORM_BASE_WEAK_PTR_H_
#define PLATFORM_BASE_WEAK_PTR_H_
...
// Weak pointers that are identical to Chromium's base::WeakPtr/WeakPtrFactory,
// in terms of behavior and usage. The implementation here is a thin wrapper
// around std::weak_ptr, for openscreen::WeakPtr; and a thin wrapper around
// std::shared_ptr, for openscreen::WeakPtrFactory.
//
// The following is copy-and-paste from Chromium's WeakPtr documentation, with
// small modifications made for clarity/relevance to OpenScreen's concerns.
//
...
// execute the WeakPtrFactory destructor. Otherwise, accessing anything through
// the WeakPtr would be racey, often with disasterous consequences (e.g.,
// use-after-free).
...
#endif  // PLATFORM_BASE_WEAK_PTR_H_
