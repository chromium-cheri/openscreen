...
class FakeEventWaiter final : public TaskRunnerImpl::EventWaiter {
 public:
  explicit FakeEventWaiter(platform::ClockNowFunctionPtr now_function)
      : now_function_(now_function) {}
  ~FakeEventWaiter() override = default;

  void Wait(Clock::duration timeout) override {
  ...
  void WakeUp() override { has_event_.store(true); }
...
class TaskRunnerWithWaiterFactory {
 public:
  static std::unique_ptr<TaskRunner> Create(
    ...
    fake_waiter = std::make_unique<FakeEventWaiter>(now_function);
  ...
  static std::unique_ptr<FakeEventWaiter> fake_waiter;
};

// static
std::unique_ptr<FakeEventWaiter> TaskRunnerWithWaiterFactory::fake_waiter;
...
TEST(TaskRunnerTest, TaskRunnerUsesEventWaiter) {
  ...
  FakeEventWaiter* fake_waiter = TaskRunnerWithWaiterFactory::fake_waiter.get();
