...
class TlsConnectionFactoryPosix : public TlsConnectionFactory,
 ...
 private:
  // TlsDataRouterPosix::SocketObserver override.
  //
  // ASSUMPTION: This might be called on an unknown thread, but
  // TlsDataRouterPosix must guarantee that the thread executing the
  // |task_runner_| is blocked while this method is being called. Otherwise,
  // races will ensue.
  //
