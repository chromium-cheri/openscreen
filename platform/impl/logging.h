...
// only be called for tests as it creates a global append-only buffer of log
// messages in memory.
...
// should only be called for assertion macro tests.  break_was_called will be
// set to true when Break() is called afterwards.  Calling with nullptr
// re-enables normal assertion behavior.
