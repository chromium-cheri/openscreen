...
class NetworkReaderWriter {
 public:
  ...
  // Creates a new NetworkReaderWriter from a variable number of providers. All
  // providers are expected to live for the duration of this object's lifetime.
  NetworkReaderWriter(std::vector<Provider*> providers);
  ...
  OSP_DISALLOW_COPY_AND_ASSIGN(NetworkReaderWriter);
