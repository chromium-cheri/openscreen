...
class TcpSocketPosix : public TcpSocket {
 public:
  ...
  ErrorOr<IPEndpoint> GetPeerAddress() const override;
  TcpSocket::State GetState() const override;
 ...
 private:
  ...
  absl::optional<IPEndpoint> peer_address_;
  TcpSocket::State state_ = TcpSocket::State::kUninitialized;
};
