...
class PlatformClientPosix : public PlatformClient {
 public:
  ...
  // between iterations of the loop used to handle networking operations. Lower
  // values will result in less time being spent on this thread, but also
 ...
 private:
  ...
  // Track whether the associated instance variable has been created yet or not.
