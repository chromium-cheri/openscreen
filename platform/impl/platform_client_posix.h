...
// public modules in the Open Screen Library.  ShutDown() should be called to
// destroy the PlatformClientPosix's global singletons to save resources when
// library APIs are not in use.
//
...
class PlatformClientPosix {
 ...
 private:
  ...
  // FIXME: This doesn't make sense as both are owned.  Combine to use one
  // member.
