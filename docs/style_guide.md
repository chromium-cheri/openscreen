...
However, structs with only POD types should not explicitly declare default
constructors or copy/move assignment operators.  Structs should use [member
initializers](https://en.cppreference.com/w/cpp/language/data_members#Member_initialization)
for POD fields.
