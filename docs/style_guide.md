...
We also follow the
[Chromium C++ Do's and Don'ts](https://chromium.googlesource.com/chromium/src/+/master/styleguide/c++/c++.md).

C++11 features are allowed in the Open Screen Library according to the
[C++ use in Chromium](https://chromium-cpp.appspot.com) guidelines.
