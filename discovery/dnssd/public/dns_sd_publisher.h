...
class DnsSdPublisher {
 public:
  ...
  // those of a previously published record. If either this is not true or if
  // no changes have occurred, an error will be returned, or on failure
  // conditions defined by the embedder. Else, Error::None is returned.
