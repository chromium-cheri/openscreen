 ...
 public:
  class Client {
   public:
    ...
    // Callback called when a record id is successfully claimed and published
    // the Register() method. these to records are expected to only differ in
    ...
    virtual void OnInstanceIdClaimed(
