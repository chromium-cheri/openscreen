...
class DnsData {
 public:
  // Validates the provided InstanceKey, returning an error if it is invalid and
  // a new DnsData otherwise.
  static ErrorOr<DnsData> Create(const InstanceKey& instance_id);
