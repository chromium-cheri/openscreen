...
class MdnsResponderAdapter {
 public:
  ...
  // |advertise| controls whether A/AAAA records are generated for this
  // interface when publishing a service.  It should be false when there are no
  // services being published, but true otherwise.
