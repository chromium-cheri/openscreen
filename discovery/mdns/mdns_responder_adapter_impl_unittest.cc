...
TEST(MdnsResponderAdapterImplTest, ExampleData) {
  ...
  mdns_adapter->Init();
  mdns_adapter->StartPtrQuery(openscreen_service, 0);
  ...
  mdns_adapter->StartSrvQuery(ptr[0].service_instance, 0);
  mdns_adapter->StartTxtQuery(ptr[0].service_instance, 0);
  mdns_adapter->RunTasks();
  ...
  mdns_adapter->StartAQuery(srv[0].domain_name, 0);
  mdns_adapter->RunTasks();
