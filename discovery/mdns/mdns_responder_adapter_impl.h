...
class MdnsResponderAdapterImpl final : public MdnsResponderAdapter {
 public:
  ...
  void StartAQuery(const DomainName& domain_name) override;
  void StartAaaaQuery(const DomainName& domain_name) override;
  void StartPtrQuery(const DomainName& service_type) override;
  void StartSrvQuery(const DomainName& service_instance) override;
  void StartTxtQuery(const DomainName& service_instance) override;

  void StopAQuery(const DomainName& domain_name) override;
  void StopAaaaQuery(const DomainName& domain_name) override;
  void StopPtrQuery(const DomainName& service_type) override;
  void StopSrvQuery(const DomainName& service_instance) override;
  void StopTxtQuery(const DomainName& service_instance) override;
