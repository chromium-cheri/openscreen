...
void MdnsSender::OnRead(UdpSocket* socket, ErrorOr<UdpPacket> packet_or_error) {
  // This method should never be called for MdnsSender.
  OSP_UNIMPLEMENTED();
}

void MdnsSender::OnError(UdpSocket* socket, Error error) {
  // This method should never be called for MdnsSender.
  OSP_UNIMPLEMENTED();
}
