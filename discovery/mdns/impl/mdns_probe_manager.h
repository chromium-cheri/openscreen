...
#ifndef DISCOVERY_MDNS_IMPL_MDNS_PROBE_MANAGER_H_
#define DISCOVERY_MDNS_IMPL_MDNS_PROBE_MANAGER_H_

#include <memory>
#include <utility>
#include <vector>

#include "discovery/mdns/impl/mdns_probe.h"
...
#endif  // DISCOVERY_MDNS_IMPL_MDNS_PROBE_MANAGER_H_
