...
std::unique_ptr<MdnsService> MdnsService::Create(
    ...
    Config::NetworkInfo::SupportedNetworkAddressFamily
...
MdnsServiceImpl::MdnsServiceImpl(
    ...
    const Config& config,
    NetworkInterfaceIndex network_interface,
    Config::NetworkInfo::SupportedNetworkAddressFamily supported_address_types)
  ...
  if (supported_address_types & Config::NetworkInfo::kUseIpV4Multicast) {
  ...
  if (supported_address_types & Config::NetworkInfo::kUseIpV6Multicast) {
    ErrorOr<std::unique_ptr<UdpSocket>> socket = UdpSocket::Create(
