...
bool IsGreaterThan(const Rdata& lhs, const Rdata& rhs) {
  ...
  // result.
  size_t lhs_size = lhs_cast.MaxWireSize() + 2;
  size_t rhs_size = rhs_cast.MaxWireSize() + 2;
  ...
  bool lhs_write = lhs_writer.Write(lhs_cast);
  bool rhs_write = rhs_writer.Write(rhs_cast);
