...
#ifndef DISCOVERY_COMMON_CONFIGURATION_PARAMETERS_H_
#define DISCOVERY_COMMON_CONFIGURATION_PARAMETERS_H_
...
#endif  // DISCOVERY_COMMON_CONFIGURATION_PARAMETERS_H_
