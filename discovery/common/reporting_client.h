...
// This class is used to report changes in the underlying discovery
// implementation back to the owning class.
...
class ReportingClient {
 public:
  ...
  // infrastructure from which recovery cannot be initiated.
